...
const ProductCard = ({img,name,price} : {img:string,name:string,price:number})=> {
    return <div className="px-3 py-5 flex flex-col hover:shadow-xl duration-500 cursor-pointer rounded-lg group">
            <img src={img || noImage} alt={name} className="w-[200px] h-[300px] object-cover self-center scale-2 group-hover:scale-110 z-[-10] duration-500"/>
